...
parser.add_argument('--model', type=str, default="HRFormer", help = 'Transformer, RETAIN, StageNet, KAME, GCT, DDHGNN, HRFormer')
...
if args.model == 'Transformer':
    ...
    model = HRFormer(Tokenizers, 128, len(task_dataset.get_all_tokens('conditions')),
